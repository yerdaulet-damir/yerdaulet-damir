...
I build constraints for the two places AI output usually breaks: copy that says nothing and software that cannot survive production. Redpen and Hookmaxxing force claims through reader truth and visible proof. Vibe Coding Rules applies the same discipline to architecture. Awesome Solo AI packages the tools into an operating stack for one-person companies.

[![Redpen, Hookmaxxing, Vibe Coding Rules and Awesome Solo AI](https://coolreadme.xyz/api/projects-gallery?user=yerdaulet-damir&projects=redpen|A+truth+ledger+and+critic+for+copy+that+must+be+specific,+falsifiable+and+owned+by+one+product.|Python||https://github.com/yerdaulet-damir/redpen;;hookmaxxing|A+hook+system+built+around+one+viewer,+one+argument,+visible+proof+and+an+exact+payoff.|Python||https://github.com/yerdaulet-damir/hookmaxxing;;vibe-coding-rules|54+drop-in+rules+that+keep+FastAPI,+Next.js+and+Go+agent+builds+maintainable+after+prototype.|TypeScript||https://github.com/yerdaulet-damir/vibe-coding-rules;;awesome-solo-ai|The+tool,+skill+and+MCP+library+for+operating+a+one-person+AI+company.|Markdown||https://github.com/yerdaulet-damir/awesome-solo-ai&title=AI%20OUTPUT%2C%20WITH%20CONSTRAINTS&subtitle=Copy%20%C2%B7%20hooks%20%C2%B7%20production%20code%20%C2%B7%20solo%20operations&theme=dark&accent=F472B6&v=20260910a)](https://github.com/yerdaulet-damir)
